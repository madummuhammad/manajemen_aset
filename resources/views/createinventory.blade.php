                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Tambah Aset Inventory</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <form method="POST" action="{{url('inventory/create')}}">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label>Kode Inventory {{$nama_grup->nama_grup}}</label>
                                                    <input type="text" class="form-control" placeholder="" name="kode_inventory">
                                                </div>
                                                <input type="text" name="id_grup_aset" value="{{Request::segment(3)}}" hidden>
                                                <div class="form-group col-md-6">
                                                    <label>Nama Inventory {{$nama_grup->nama_grup}}</label>
                                                    <input type="text" class="form-control" placeholder="" name="nama_inventory">
                                                </div>
                                                <div class="form-group col-md-6">
